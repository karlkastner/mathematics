% 2012-05-22 09:43:55 UTC
% Karl Kästner, Berlin

% finite differrence coefficients computed by matrix powers
% at the moment intended for 5-element kernel
...
function [D4 A2_] = derive_fdm_power(x)
