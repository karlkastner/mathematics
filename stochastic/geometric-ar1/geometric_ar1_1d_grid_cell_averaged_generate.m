...
%%
%%
function [val, cov_] = geometric_ar1_1d_grid_cell_averaged_generate(lmu,lsd,theta,L,n,varargin)
	...
	cov_ = geometric_ar1_1d_grid_cell_averaged_cov(lmu,lsd,theta,x,dx,varargin{:});
	...
	val = exp(z);
end % geometric_ar1_1d_grid_cell_averaged_generate
