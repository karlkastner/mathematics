...
function sd = geometric_ar1_2d_grid_cell_averaged_std(lmu,lsd,theta,dx,dy,varargin)
	...
	s2 = geometric_ar1_2d_grid_cell_averaged_cov(lmu,lsd,theta,0,0,dx,dy,varargin{:});
	sd = sqrt(s2);
end
