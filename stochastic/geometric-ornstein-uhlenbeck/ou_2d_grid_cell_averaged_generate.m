...
%%
function [val,cov_] = ar1_2d_grid_cell_averaged_generate(mu,sd,theta,L,n,varargin)
	...
	cov_ = ar1_2d_grid_cell_averaged_cov(mu,sd,theta,xx,yy,dx,dy,varargin{:});
...
end % ar1_2d_grid_cell_averaged_generate
